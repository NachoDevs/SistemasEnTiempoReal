...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mainherenciaprioridad" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#bf7cbe7f#;
   pragma Export (C, u00001, "mainherenciaprioridadB");
   ...
   u00135 : constant Version_32 := 16#2c394567#;
   pragma Export (C, u00135, "modulosB");
   u00136 : constant Version_32 := 16#6ec9522f#;
   pragma Export (C, u00136, "modulosS");
   u00137 : constant Version_32 := 16#927a893f#;
   pragma Export (C, u00137, "ada__text_ioB");
   u00138 : constant Version_32 := 16#25015822#;
   ...
   u00144 : constant Version_32 := 16#95d1605d#;
   ...
   u00147 : constant Version_32 := 16#7d52f2a8#;
   ...
   u00149 : constant Version_32 := 16#76326c02#;
   pragma Export (C, u00149, "tipos_datosS");
   u00150 : constant Version_32 := 16#368fe94d#;
   pragma Export (C, u00150, "controlB");
   u00151 : constant Version_32 := 16#20c71cb5#;
   pragma Export (C, u00151, "controlS");
   u00152 : constant Version_32 := 16#e62603ac#;
   pragma Export (C, u00152, "ioB");
   u00153 : constant Version_32 := 16#0206cfec#;
   pragma Export (C, u00153, "ioS");
   u00154 : constant Version_32 := 16#0716ed92#;
   pragma Export (C, u00154, "str_taskingB");
   u00155 : constant Version_32 := 16#dbc949d3#;
   pragma Export (C, u00155, "str_taskingS");
   u00156 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00156, "ada__numericsS");
   u00157 : constant Version_32 := 16#d976e2b4#;
   pragma Export (C, u00157, "ada__numerics__float_randomB");
   u00158 : constant Version_32 := 16#62aa8dd2#;
   pragma Export (C, u00158, "ada__numerics__float_randomS");
   u00159 : constant Version_32 := 16#ec9cfed1#;
   pragma Export (C, u00159, "system__random_numbersB");
   u00160 : constant Version_32 := 16#f1b831a2#;
   pragma Export (C, u00160, "system__random_numbersS");
   u00161 : constant Version_32 := 16#650caaea#;
   pragma Export (C, u00161, "system__random_seedB");
   u00162 : constant Version_32 := 16#69b0a863#;
   pragma Export (C, u00162, "system__random_seedS");
   u00163 : constant Version_32 := 16#b8719323#;
   pragma Export (C, u00163, "ada__calendarB");
   u00164 : constant Version_32 := 16#41508869#;
   pragma Export (C, u00164, "ada__calendarS");
   u00165 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00165, "system__val_unsB");
   u00166 : constant Version_32 := 16#168e1080#;
   pragma Export (C, u00166, "system__val_unsS");
   u00167 : constant Version_32 := 16#c15c285d#;
   pragma Export (C, u00167, "str_chronoB");
   u00168 : constant Version_32 := 16#3a235557#;
   pragma Export (C, u00168, "str_chronoS");
   u00169 : constant Version_32 := 16#341a9bf4#;
   pragma Export (C, u00169, "str_cpuB");
   u00170 : constant Version_32 := 16#ca0334fa#;
   pragma Export (C, u00170, "str_cpuS");
   u00171 : constant Version_32 := 16#357666d8#;
   pragma Export (C, u00171, "ada__calendar__delaysB");
   u00172 : constant Version_32 := 16#a808adf5#;
   pragma Export (C, u00172, "ada__calendar__delaysS");
   u00173 : constant Version_32 := 16#0fc99b06#;
   pragma Export (C, u00173, "system__tasking__rendezvousB");
   u00174 : constant Version_32 := 16#f242aaf9#;
   ...
   u00176 : constant Version_32 := 16#79d25869#;
   pragma Export (C, u00176, "system__restrictionsS");
   u00177 : constant Version_32 := 16#40317118#;
   pragma Export (C, u00177, "system__tasking__entry_callsB");
   u00178 : constant Version_32 := 16#c7180c67#;
   ...
   u00181 : constant Version_32 := 16#f29e7e8b#;
   ...
   u00183 : constant Version_32 := 16#17d21067#;
   pragma Export (C, u00183, "ada__exceptions__is_null_occurrenceB");
   u00184 : constant Version_32 := 16#e1d7566f#;
   ...
   u00191 : constant Version_32 := 16#a11c264c#;
   pragma Export (C, u00191, "system__tasking__protected_objects__operationsB");
   u00192 : constant Version_32 := 16#ba36ad85#;
   ...
   u00197 : constant Version_32 := 16#7724692c#;
   pragma Export (C, u00197, "system__tasking__stagesB");
   u00198 : constant Version_32 := 16#fb9a8375#;
   pragma Export (C, u00198, "system__tasking__stagesS");
   u00199 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00199, "system__img_realB");
   u00200 : constant Version_32 := 16#f508d0da#;
   pragma Export (C, u00200, "system__img_realS");
   u00201 : constant Version_32 := 16#36373acb#;
   pragma Export (C, u00201, "system__fat_llfS");
   u00202 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00202, "system__img_lluB");
   u00203 : constant Version_32 := 16#4feffd78#;
   pragma Export (C, u00203, "system__img_lluS");
   u00204 : constant Version_32 := 16#62d0e74f#;
   pragma Export (C, u00204, "system__powten_tableS");
   u00205 : constant Version_32 := 16#72aca55a#;
   pragma Export (C, u00205, "semaforosB");
   u00206 : constant Version_32 := 16#bf107c05#;
   pragma Export (C, u00206, "semaforosS");
   u00207 : constant Version_32 := 16#5dc07a5a#;
   pragma Export (C, u00207, "system__memoryB");
   u00208 : constant Version_32 := 16#6bdde70c#;
