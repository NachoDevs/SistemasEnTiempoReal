...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mainciclico" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#512f37c3#;
   pragma Export (C, u00001, "mainciclicoB");
   ...
   u00131 : constant Version_32 := 16#2c394567#;
   pragma Export (C, u00131, "modulosB");
   u00132 : constant Version_32 := 16#6ec9522f#;
   pragma Export (C, u00132, "modulosS");
   ...
   u00151 : constant Version_32 := 16#76326c02#;
   pragma Export (C, u00151, "tipos_datosS");
   u00152 : constant Version_32 := 16#368fe94d#;
   pragma Export (C, u00152, "controlB");
   u00153 : constant Version_32 := 16#20c71cb5#;
   pragma Export (C, u00153, "controlS");
   u00154 : constant Version_32 := 16#e62603ac#;
   pragma Export (C, u00154, "ioB");
   u00155 : constant Version_32 := 16#0206cfec#;
   pragma Export (C, u00155, "ioS");
   u00156 : constant Version_32 := 16#0716ed92#;
   pragma Export (C, u00156, "str_taskingB");
   u00157 : constant Version_32 := 16#dbc949d3#;
   pragma Export (C, u00157, "str_taskingS");
   u00158 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00158, "ada__numericsS");
   ...
   u00161 : constant Version_32 := 16#ec9cfed1#;
   ...
   u00163 : constant Version_32 := 16#650caaea#;
   ...
   u00165 : constant Version_32 := 16#b8719323#;
   pragma Export (C, u00165, "ada__calendarB");
   u00166 : constant Version_32 := 16#41508869#;
   pragma Export (C, u00166, "ada__calendarS");
   u00167 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00167, "system__val_unsB");
   u00168 : constant Version_32 := 16#168e1080#;
   pragma Export (C, u00168, "system__val_unsS");
   u00169 : constant Version_32 := 16#c15c285d#;
   pragma Export (C, u00169, "str_chronoB");
   u00170 : constant Version_32 := 16#3a235557#;
   pragma Export (C, u00170, "str_chronoS");
   u00171 : constant Version_32 := 16#341a9bf4#;
   pragma Export (C, u00171, "str_cpuB");
   u00172 : constant Version_32 := 16#ca0334fa#;
   pragma Export (C, u00172, "str_cpuS");
   u00173 : constant Version_32 := 16#357666d8#;
   pragma Export (C, u00173, "ada__calendar__delaysB");
   u00174 : constant Version_32 := 16#a808adf5#;
   pragma Export (C, u00174, "ada__calendar__delaysS");
   u00175 : constant Version_32 := 16#0fc99b06#;
   pragma Export (C, u00175, "system__tasking__rendezvousB");
   u00176 : constant Version_32 := 16#f242aaf9#;
   ...
   u00179 : constant Version_32 := 16#40317118#;
   pragma Export (C, u00179, "system__tasking__entry_callsB");
   u00180 : constant Version_32 := 16#c7180c67#;
   ...
   u00189 : constant Version_32 := 16#f24a7f45#;
   ...
   u00191 : constant Version_32 := 16#50b90464#;
   ...
   u00201 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00201, "system__img_realB");
   u00202 : constant Version_32 := 16#f508d0da#;
   pragma Export (C, u00202, "system__img_realS");
   u00203 : constant Version_32 := 16#36373acb#;
   pragma Export (C, u00203, "system__fat_llfS");
   u00204 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00204, "system__img_lluB");
   u00205 : constant Version_32 := 16#4feffd78#;
   pragma Export (C, u00205, "system__img_lluS");
   u00206 : constant Version_32 := 16#62d0e74f#;
   pragma Export (C, u00206, "system__powten_tableS");
   u00207 : constant Version_32 := 16#72aca55a#;
   pragma Export (C, u00207, "semaforosB");
   u00208 : constant Version_32 := 16#bf107c05#;
   pragma Export (C, u00208, "semaforosS");
   u00209 : constant Version_32 := 16#5dc07a5a#;
